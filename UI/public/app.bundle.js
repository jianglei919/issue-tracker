...
/* harmony export */   "default": () => (/* binding */ MyCounter)
/* harmony export */ });
...
function MyCounter() {
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(100),
    ...
    addCounter = _useState2[1];
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
    _useState4 = _slicedToArray(_useState3, 2),
    user = _useState4[0],
    changeUser = _useState4[1];
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    document.title = "".concat(user, " clicked ").concat(counter, " times");
    changeUser('Nasser');
  });
  ...
  }, "click me"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, user, " clicked ", counter, " times"));
}
var CounterClass = /*#__PURE__*/function (_React$Component) {
  function CounterClass() {
    var _this;
    _classCallCheck(this, CounterClass);
    _this = _callSuper(this, CounterClass);
    _this.state = {
      counter: 0,
      user: "Andrew"
    };
  ...
  _inherits(CounterClass, _React$Component);
  return _createClass(CounterClass, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate() {
      document.title = "".concat(this.state.user, " clicked ").concat(this.state.counter, " times");
    }
  }, {
    key: "addCount",
    ...
    value: function render() {
      ...
      }, "click me"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, this.state.user, " clicked ", this.state.counter, " times"));
    }
  }]);
...
var IssueAdd = /*#__PURE__*/function (_React$Component) {
  function IssueAdd() {
    ...
    _this = _callSuper(this, IssueAdd, [].concat(args));
...
var IssueFilter = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(IssueFilter, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "This is Issue Filter"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
        type: "text",
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _IssueAdd_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./IssueAdd.jsx */ "./JSX/IssueAdd.jsx");
/* harmony import */ var _IssueTable_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./IssueTable.jsx */ "./JSX/IssueTable.jsx");
/* harmony import */ var _IssueFilter_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./IssueFilter.jsx */ "./JSX/IssueFilter.jsx");
...
function getParam(Il) {
  return function (props) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Il, _extends({}, props, {
      myparam: (0,react_router_dom__WEBPACK_IMPORTED_MODULE_4__.useParams)(),
      myloc: (0,react_router_dom__WEBPACK_IMPORTED_MODULE_4__.useLocation)()
    }));
  };
}
  ...
  return _createClass(IssueList, [{
    ...
    value: function () {
      var _loadData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var query, myparamid, response, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              query = "query {\n                        issueList {\n                            id\n                            title\n                            status\n                            owner\n                            created\n                            effort\n                            due\n                        }\n                    }";
              myparamid = this.props.myparam.id;
              _context.next = 4;
    ...
    key: "insertIssue",
    value: function () {
      var _insertIssue = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(issue) {
        var query;
      ...
      function insertIssue(_x) {
        return _insertIssue.apply(this, arguments);
      }
      return insertIssue;
    }()
  }, {
    ...
    value: function getFilter() {
      var _this2 = this;
      var myl = this.state.issues.slice();
      if (typeof this.props.myparam.id !== 'undefined') {
        var result = myl.filter(function (issue) {
          return issue.id == _this2.props.myparam.id;
        });
        return result;
      }
      if (typeof this.props.page !== 'undefined') {
        return myl.sort(function (a, b) {
          return a.id >= b.id ? 1 : -1;
        }).slice(Number(this.props.page) * 10 - 10, Number(this.props.page));
    ...
    key: "render",
    value: function render() {
      var myList = this.getFilter();
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_IssueFilter_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_IssueTable_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
        issues: myList
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_IssueAdd_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], {
        insertIssue: this.insertIssue.bind(this)
      }));
    }
  }]);
}((react__WEBPACK_IMPORTED_MODULE_0___default().Component));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getParam(IssueList));
...
var IssueTable = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(IssueTable, [{
    ...
    value: function render() {
      ...
      var _this$props$issues = this.props.issues,
        issues = _this$props$issues === void 0 ? [] : _this$props$issues;
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("table", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("thead", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th", {
        ...
        style: rowStyle
      }, "Opeation"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tbody", null, rows));
    }
  }]);
}((react__WEBPACK_IMPORTED_MODULE_0___default().Component));
  ...
  return _createClass(IssueRow, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
        ...
        to: "/issues/".concat(this.props.issue.id)
      }, "Edit")));
    }
  }]);
}((react__WEBPACK_IMPORTED_MODULE_0___default().Component));
...
/* harmony import */ var _IssueList_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./IssueList.jsx */ "./JSX/IssueList.jsx");
/* harmony import */ var _Counter_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Counter.jsx */ "./JSX/Counter.jsx");
...
var IssueReport = function IssueReport() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "This is my report page");
};
var Home = function Home() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "This is my home page");
};
var EditIssue = function EditIssue() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "This is my edit page");
};
function Contents() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, {
    to: "/issues"
  }, "IssueList | "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, {
    to: "/report"
  }, "Report | "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, {
    to: "/Edit/123"
  }, "Edit123 | "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, {
    to: "/issues/123/new"
  }, "IssueList123new | "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, {
    to: "/counter"
  }, "counter "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Routes, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, {
    path: "/",
    ...
    path: "/issues",
    element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_IssueList_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], null)
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, {
    path: "/issues/:id",
    element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_IssueList_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], {
      page: 2
    })
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, {
    path: "/Edit/:id",
    element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(EditIssue, {
      page: 2
    })
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, {
    ...
    path: "/report",
    element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IssueReport, null)
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, {
    path: "/counter",
    element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Counter_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], null)
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, {
    path: "*",
